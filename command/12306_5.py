    ...
    for i in json_data['data']['result']:
        ...
        for j in name:
            if data[j] == "":
                data[j] = "-"
        tb.add_row([
          Fore.YELLOW + data["train_code"] + Fore.RESET,
          Fore.GREEN + station_name[data["from_station_name"]] + Fore.RESET,
          Fore.GREEN + station_name[data["to_station_name"]] + Fore.RESET,
          Fore.MAGENTA + data["start_time"] + Fore.RESET,
          Fore.MAGENTA + data["arrive_time"] + Fore.RESET,
          Fore.RED + data["lishi"] + Fore.RESET,
          data["swz"],
          data["first"],
          data["second"],
          data["gjrw"],
